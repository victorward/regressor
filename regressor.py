...
def find_best_lmbda(options, best_model, random_polynomials, scaled_set_points, scaled_test_points, points_min_max):
    ...
    new_teta = utils.gradient(linear_set_points_with_1, options.alpha_iterations, options.alpha_learning_rate, best_model.lmbda)
...
def apply_calculations(options, set_points, test_points):
    ...
    best_lmbda = find_best_lmbda(options, best_model, random_polynomials, scaled_set_points, scaled_test_points,
                                 set_points_min_max)

    utils.print_results(best_lmbda)
